...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="py-20 px-4 bg-gray-50 dark:bg-gray-800/50 transition-colors">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="bg-gray-200 dark:bg-gray-700 text-blue-600 dark:text-blue-400 px-2 py-1 rounded text-sm"
                    >
                      {tech}
                    </span>
                  ))}
